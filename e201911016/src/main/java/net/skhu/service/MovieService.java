...
public class MovieService {
	...
	public void insert(MovieEdit movieEdit, BindingResult bindingResult) throws Exception {
	...
	public void update(MovieEdit movieEdit, BindingResult bindingResult) throws Exception {
		if (hasErrors(movieEdit, bindingResult))
			throw new Exception("입력 데이터 오류");
		Movie movie = toDto(movieEdit);
