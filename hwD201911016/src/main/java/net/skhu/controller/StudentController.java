...
public class StudentController {
	...
	public String create(Model model) {
		ProfessorEdit studentEdit = new ProfessorEdit();
	...
	@PostMapping("create")
	public String create(Model model, @Valid ProfessorEdit studentEdit, BindingResult bindingResult) {
		try {
	...
	public String edit(Model model, int id) {
		ProfessorEdit studentEdit = studentService.findOne(id);
		List<Department> departments = departmentService.findAll();
		model.addAttribute("studentEdit", studentEdit);
		model.addAttribute("departments", departments);
		return "student/edit";
	...
	public String edit(Model model, @Valid ProfessorEdit studentEdit, BindingResult bindingResult) {
	...
	public String delete(Model model, ProfessorEdit studentEdit, BindingResult bindingResult) {
		try {
